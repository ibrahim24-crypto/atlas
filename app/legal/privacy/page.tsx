  ...
  return (
    <main className="bg-[#0a0a0a] text-[#f5f0eb]">
      ...
      <section className="pt-24 md:pt-40 pb-20 md:pb-40 px-4 md:px-16 max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-serif text-[#f5f0eb] mb-8">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-[#c4b8a8]">
          <section className="space-y-4">
            ...
            <p className="body-lg text-sm md:text-base">
              ATLAS MARAKECH ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-[#c9a96e]">2. Information We Collect</h2>
            <p className="body-lg text-sm md:text-base">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-[#c9a96e]">3. How We Use Your Information</h2>
            <p className="body-lg text-sm md:text-base">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-[#c9a96e]">4. Data Security</h2>
            <p className="body-lg text-sm md:text-base">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-[#c9a96e]">5. Your Rights</h2>
            <p className="body-lg text-sm md:text-base">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-[#c9a96e]">6. Contact Us</h2>
            <p className="body-lg text-sm md:text-base">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/legal/privacy" className="body-md text-[#c9a96e] text-xs md:text-base">Privacy</a></li>
