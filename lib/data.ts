export const products = [
  {
    ...
    image: '/images/Gmail/1000106365.png',
  ...
  },
  {
    ...
    image: '/images/Gmail/1000106389.png',
  ...
  },
  {
    ...
    image: '/images/Gmail/1000106399.png',
  ...
  },
  {
    ...
    image: '/images/Gmail/1000106356.png',
  ...
  },
  {
    ...
    image: '/images/Gmail/1000106361.png',
  ...
  },
  {
    ...
    image: '/images/Gmail/1000106367.png',
...
export const ingredients = [
  { name: 'Oud', origin: 'Assam, India', image: '/images/Gmail/1000106356.png', description: 'The king of fragrance woods' },
  { name: 'Saffron', origin: 'Khorasan, Iran', image: '/images/Gmail/1000106367.png', description: 'The most precious spice on earth' },
  { name: 'Amber', origin: 'Baltic Coast', image: '/images/Gmail/1000106373.png', description: 'Fossilized warmth of ancient seas' },
  { name: 'Rose', origin: 'Grasse, France', image: '/images/Gmail/1000106361.png', description: 'The queen of floral notes' },
  { name: 'Bergamot', origin: 'Calabria, Italy', image: '/images/Gmail/1000106391.png', description: 'The sunlit citrus spark' },
  { name: 'Iris', origin: 'Tuscany, Italy', image: '/images/Gmail/1000106365.png', description: 'Powdery elegance of the earth' },
  { name: 'Musk', origin: 'Ethical Sources', image: '/images/Gmail/1000106388.png', description: 'The intimate skin-warm base' },
  { name: 'Vetiver', origin: 'Haiti', image: '/images/Gmail/1000106399.png', description: 'Earthy roots of sophistication' }
];

export const socialAccounts = [
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/atlas_marakech/',
    icon: 'instagram'
  },
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/profile.php?id=61589002400891',
    icon: 'facebook'
  },
  {
    name: 'X',
    url: 'https://twitter.com/atlasmarakech',
    icon: 'x'
  },
  {
    name: 'Threads',
    url: 'https://www.threads.net/@atlas_marakech',
    icon: 'threads'
  },
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@atlasmarrakech',
    icon: 'youtube'
  }
];
...
export const menuTabs = [
  { label: 'Discover', items: ['The Brand', 'Our Philosophy', 'Marrakech Inspiration'] },
  { label: 'Collection', items: ['All Fragrances', 'Limited Editions', 'Archive'] },
  { label: 'Experience', items: ['Atelier Visits', 'Consultations', 'Events'] },
  { label: 'Journal', items: ['Latest Stories', 'Interviews', 'Ingredient Deep Dives'] },
];
